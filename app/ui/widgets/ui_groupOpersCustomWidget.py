...
"}")
        ...
        self.widget = QWidget(self.operationsInfoHolder)
        ...
        self.widget.setMaximumSize(QSize(320, 16777215))
    ...
    def retranslateUi(self, customWidgetGroupOpers):
        ...
        self.label.setText(QCoreApplication.translate("customWidgetGroupOpers", u"\u041e\u043f\u0435\u0440\u0430\u0446\u0438\u0438", None))
